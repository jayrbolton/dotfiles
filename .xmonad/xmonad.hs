...
-- notify the volume percentage with notify-osd. For use with spawn
notifyVolume = " killall notify-osd ; notify-send \"Volume $(amixer get Master | awk '$0~/%/{print $4}' | tr -d '[]')\""
